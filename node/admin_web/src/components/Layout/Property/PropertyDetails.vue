                ...
                <div class="md-layout md-gutter">
                    ...
                    <div class="md-layout-item md-small-size-100 md-size-50">
                        <md-field>
                            ...
                            <md-select v-model="propiedad.propiedad_tipo_id" name="propiedad_tipo_id" id="propiedad_tipo_id">
                ...
                <div class="md-layout md-gutter">
                    <div class="md-layout-item md-small-size-100 md-size-50">
                        <md-field>
                            ...
                            <md-select v-model="propiedad.propiedad_estado_id" name="propiedad_estado_id" id="propiedad_estado_id">
                                <md-option v-for="i in estadosPropiedad" :value="i.id" :key="i.id">{{ i.nombre }}</md-option>
                            </md-select>
                            <span class="md-helper-text" v-if="propiedad.fecha_cambio_estado">Última actulización {{propiedad.fecha_cambio_estado}}</span>
                        </md-field>
                    </div>
                    <div class="md-layout-item md-small-size-100 md-size-50">
                        <md-field>
                            <label for="departamento_origen_id">Departamento de Origen</label>
                            <md-select v-model="propiedad.departamento_origen_id" name="departamento_origen_id" id="departamento_origen_id">
...
export default {
    ...
    methods: {
        ...
        async getTiposPropiedad() {
            ...
            if (this.tiposPropiedad && !this.isUpdating) {
        ...
        async getEstadosPropiedad() {
            ...
            if (this.estadosPropiedad && !this.isUpdating) {
        ...
        async getDepartamentosOrigen() {
            ...
            if (this.departamentosOrigen && !this.isUpdating) {
